...
if vectorstore is None:
    ...
    if prompt := st.chat_input("Sorunu sor (Örn: Bana program hazırla)..."):
        ...
        4. **Video Entegrasyonu (Görsel Eğitim):** Hareketleri yazarken, eğer veritabanında o hareketin video linki varsa, **MUTLAKA** hareketin hemen altına tıklanabilir link formatında ekle. Örn:
           *   **Bench Press**
               [📺 İzle ve Öğren](https://youtube.com/...)
